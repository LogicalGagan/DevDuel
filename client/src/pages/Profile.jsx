...
const getTier = (r) => {
  if (!r || r < 1200) return { label: 'Bronze', icon: <MedalIcon size={20} className="text-[var(--lc-accent-orange)]" />, next: 1200, min: 0, bar: 'var(--lc-accent-orange)', text: 'text-[var(--lc-accent-orange)]', badge: 'bg-[var(--lc-accent-orange)]/10 border-[var(--lc-accent-orange)]/30 text-[var(--lc-accent-orange)]' };
