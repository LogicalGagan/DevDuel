...
const Matchmaking = () => {
  ...
  const roundOptions = [
    { value: 1, label: 'Quick 1v1', desc: 'Single question', icon: <LightningIcon size={24} className="text-[var(--lc-accent-orange)]" /> },
    { value: 3, label: 'Best of 3', desc: 'Standard match', icon: <FlameIcon size={24} className="text-[var(--lc-accent-orange)]" /> },
                      ...
                      <>
                        ...
                        <div className="lc-card rounded-xl border border-purple-500/30 bg-slate-800/40 p-6 space-y-4 shadow-lg">
                          ...
                          <div>
                            ...
                            {!selectedRounds && (
                              <p className="text-[11px] text-[var(--lc-accent-blue)]/80 mt-2 text-center">⚠️ Select a format to create a room</p>
                            )}
                          </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                      ...
                      <div className="lc-card p-6 rounded-xl border border-slate-700/50 backdrop-blur bg-slate-800/40 shadow-lg hover:shadow-xl transition-all">
                        ...
                        {!selectedRounds && (
                          <p className="text-[11px] text-[var(--lc-accent-blue)]/80 mt-3 text-center">⚠️ Select a format to join queue</p>
                        )}
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div className="lc-card p-4 rounded-lg border border-slate-700/50 bg-slate-800/40 backdrop-blur border-l-4 border-l-orange-500 hover:shadow-lg transition-all">
                          <h3 className="font-bold text-slate-50 mb-1 text-sm flex items-center gap-2"><LightningIcon size={18} className="text-[var(--lc-accent-orange)]" /> Lightning Fast Matching</h3>
                      ...
                      >
                        <span className="relative z-10 flex items-center justify-center gap-2">
                          ...
                          {selectedRounds && <LightningIcon className="group-hover:scale-110 transition-transform text-[var(--lc-accent-orange)]" size={20} />}
                        </span>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="lc-card p-4 rounded-lg border border-slate-700/50 backdrop-blur bg-slate-800/40 shadow-lg hover:shadow-xl transition-all">
                        ...
                        <div className="space-y-4">
                          {/* Rating */}
                          <div className="p-3 rounded-lg bg-gradient-to-br from-orange-500/10 to-orange-600/10 border border-[var(--lc-accent-orange)]/30">
                            <p className="text-xs text-[var(--lc-accent-orange)] font-semibold uppercase tracking-wider mb-1">Rating</p>
                            <p className="text-2xl font-black text-[var(--lc-accent-orange)]">{user?.rating || 1200}</p>
                          </div>
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-right text-sm font-bold text-[var(--lc-accent-orange)]">{winRate}%</p>
                          </div>
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 px-4 backdrop-blur-sm">
          <div className="lc-card rounded-2xl border border-slate-700/50 w-full max-w-sm p-8 shadow-2xl">
            ...
            <p className="text-slate-400 mb-6 leading-relaxed">
              ...
              {inQueue && (
                <span className="block mt-3 text-[var(--lc-accent-orange)] font-semibold">
