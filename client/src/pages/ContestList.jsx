      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-4 pb-16">
        <div className="max-w-5xl mx-auto px-5 py-4">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-black mb-2 flex items-center gap-3 bg-gradient-to-r from-violet-400 via-violet-500 to-indigo-500 bg-clip-text text-transparent">
                <TrophyIcon size={32} className="text-[var(--lc-accent-orange)]" /> Contests
              </h1>
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center py-20 gap-4">
              <div className="relative w-12 h-12">
                ...
                <div className="w-12 h-12 rounded-full border-2 border-t-transparent border-[var(--lc-accent-orange)] animate-spin" />
              </div>
            ...
            <div className="text-center py-20 rounded-2xl bg-slate-800/30 border border-slate-700/50 backdrop-blur">
              <div className="flex justify-center mb-4 text-[var(--lc-accent-orange)] opacity-80"><TrophyIcon size={64} /></div>
                      ...
                      <div className="text-right shrink-0">
                        {c.status === 'scheduled' && (
                          <div>
                            ...
                            <p className="text-xl font-black text-[var(--lc-accent-orange)]">{getTimeLeft(c.startTime)}</p>
                          </div>
                        )}
                        {c.status === 'active' && (
