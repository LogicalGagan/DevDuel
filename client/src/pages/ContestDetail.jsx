    ...
    return (
      <AppShell>
        <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 flex flex-col items-center justify-center gap-4">
          ...
          <button onClick={() => navigate('/contests')} className="text-sm text-[var(--lc-accent-orange)] hover:underline font-mono">← Back to contests</button>
        </div>
      </AppShell>
    );
  }
              ...
              <div className="text-right shrink-0 space-y-3">
                {isScheduled && countdown && (
                  <div className="p-3 rounded-xl bg-slate-900/60 border border-slate-700/50">
                    ...
                    <p className="text-xl font-black font-mono text-[var(--lc-accent-orange)]">{countdown}</p>
                  </div>
                )}
                  ...
                  {leaderboard.length === 0 ? (
                    ...
                    return (
                      <tr key={entry.userId || idx}
                        ...
                        style={{ backgroundColor: isMe ? 'rgba(139,92,246,0.08)' : idx % 2 === 0 ? 'rgba(15,23,42,0.5)' : 'rgba(15,23,42,0.3)' }}>
                        <td className="py-3 px-4 font-black font-mono" style={{ color: idx < 3 ? 'var(--lc-accent-orange)' : '#64748b' }}>
                          {medal || (idx + 1)}
                        </td>
                        <td className="py-3 px-4">
                          <span className="font-bold flex items-center gap-1" style={{ color: isMe ? 'var(--lc-accent-orange)' : '#f1f5f9' }}>
                        ...
                        <td className="py-3 px-4 text-center font-black text-[var(--lc-accent-orange)]">{entry.score || 0}</td>
                      </tr>
                    );
                  })}
                </tbody>
