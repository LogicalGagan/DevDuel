      ...
      <div className="min-h-screen pt-20 pb-16">
        <div className="max-w-[1200px] mx-auto p-6 space-y-8">
          ...
          <div>
            <div className="mb-6">
              <h2 className="text-3xl font-bold mb-2 flex items-center gap-2">
                <LightningIcon className="text-[var(--lc-accent-orange)]" size={32} /> Ongoing Tournaments
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="lc-card p-6 hover:border-accent-orange/50 transition-all cursor-pointer">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <TrophyIcon size={24} className="text-[var(--lc-accent-orange)]" />
                </div>
              ...
              <div className="lc-card p-6 hover:border-accent-orange/50 transition-all cursor-pointer">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <LightningIcon size={24} className="text-[var(--lc-accent-orange)]" />
                </div>
                <div className="space-y-3 mb-4">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-400">Players</span>
              ...
              <div className="lc-card p-6 hover:border-accent-orange/50 transition-all cursor-pointer">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <TargetIcon size={24} className="text-[var(--lc-accent-orange)]" />
                </div>
                <div className="space-y-3 mb-4">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-400">Players</span>
          ...
          <div>
            <div className="mb-6">
              <h2 className="text-3xl font-bold mb-2 flex items-center gap-2">
                <FlameIcon className="text-[var(--lc-accent-orange)]" size={32} /> Available Clashes
              </h2>
