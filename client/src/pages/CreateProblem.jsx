            ...
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="flex items-center gap-3 mb-8">
                    <button onClick={() => navigate(-1)}
                        ...
                        <span className="text-[var(--lc-accent-orange)] font-bold">←</span>
                    </button>
                    <div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                {testCases.map((tc, idx) => (
                                    <div key={idx} className="p-4 rounded-xl relative group" style={{ backgroundColor: 'rgba(0,0,0,0.2)', border: '1px solid var(--lc-border)' }}>
                                        ...
                                        <div className="flex items-center justify-between mb-3 border-b pb-2" style={{ borderColor: 'var(--lc-border)' }}>
                                            <span className="text-xs font-mono font-bold text-[var(--lc-accent-orange)]">CASE #{idx + 1}</span>
                    ...
                    <div className="flex justify-end pt-4">
                        <button type="submit" disabled={loading}
                            ...
                            style={{ background: 'linear-gradient(135deg,var(--lc-accent-orange),#6366f1)', color: '#1a1a1a', boxShadow: '0 0 20px rgba(139,92,246,0.3)' }}>
