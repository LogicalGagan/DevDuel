                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                      ...
                      {isPrivate ? (
                        ...
                        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-[var(--lc-accent-orange)]/15 border border-[var(--lc-accent-orange)]/40 text-orange-300 flex-shrink-0">
                          🏆 Ranked
                        </span>
                      )}
                      {/* Rounds badge */}
