    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ backgroundColor: isWin ? 'var(--lc-accent-orange)' : '#dc2626' }}
        />
        ...
        <div className="relative px-8 pt-8 pb-8 flex flex-col items-center">
          ...
          <div
            ...
            style={{
              backgroundColor: isWin ? 'rgba(139,92,246,0.1)' : 'rgba(220,38,38,0.1)',
              border: `1px solid ${isWin ? 'rgba(139,92,246,0.3)' : 'rgba(220,38,38,0.3)'}`,
            }}
          >
            {isWin ? '🏆' : '💀'}
          </div>
          ...
          <div
            ...
            style={{
              color: isWin ? 'var(--lc-accent-orange)' : '#f87171',
              backgroundColor: isWin ? 'rgba(139,92,246,0.1)' : 'rgba(220,38,38,0.1)',
              border: `1px solid ${isWin ? 'rgba(139,92,246,0.3)' : 'rgba(220,38,38,0.3)'}`,
            }}
          >
          ...
          {result.reason && (
            <div
              ...
              style={{
                color: isWin ? 'var(--lc-accent-orange)' : '#f87171',
                backgroundColor: isWin ? 'rgba(139,92,246,0.08)' : 'rgba(220,38,38,0.08)',
                border: `1px solid ${isWin ? 'rgba(139,92,246,0.25)' : 'rgba(220,38,38,0.25)'}`,
              }}
            >
              <span className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: isWin ? 'var(--lc-accent-orange)' : '#ef4444' }} />
          ...
          <div className="w-full flex flex-col gap-3">
            ...
            <button
              ...
              style={{ backgroundColor: 'var(--lc-accent-orange)', color: '#1a1a1a' }}
            >
              Play Again
            </button>
