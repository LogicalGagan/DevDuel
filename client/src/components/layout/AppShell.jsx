...
const AppShell = ({ children }) => {
  ...
  const navItems = [
    { to: '/', label: 'Explore' },
    { to: '/matchmaking', label: 'Join Match', auth: true },
      ...
      <nav className="sticky top-0 z-50 h-12 flex items-center px-4 justify-between border-b"
        ...
        <div className="flex items-center gap-6">
          <Link to="/" className="flex items-center gap-2 no-underline">
            ...
            <span className="text-white font-bold text-lg tracking-tight">DevDuel</span>
          </Link>
              ...
              >
                ...
                <div className="py-1">
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-4 py-2.5 text-left hover:bg-white/5 transition-colors"
                  >
                    <span className="material-symbols-outlined text-lg text-[var(--lc-accent-orange)]">bug_report</span>
                    <div>
                  ...
                  >
                    ...
                    <div>
                      <span className="text-xs font-semibold text-white block">About DevDuel</span>
            ...
            <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm">
              ...
              >
                <div className="px-6 py-5 text-center">
                  ...
                  <h3 className="text-sm font-bold text-white mb-1">Sign out of DevDuel?</h3>
